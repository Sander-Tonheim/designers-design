	...
	return (
		<nav className=' sticky left-0 top-0 z-50 w-full bg-white'>
			<div className='mx-auto h-[88px] max-w-screen-xl items-center  p-6 md:relative md:flex md:justify-between md:px-8 md:py-7'>
				...
				<div
					className={` absolute left-0 top-[88px] flex w-full justify-self-center overflow-hidden transition-[height] duration-300 ease-in-out md:relative  md:top-0  md:flex md:h-full md:w-fit md:items-center md:justify-between md:bg-transparent md:backdrop-blur-none bg-black backdrop-blur-sm bg-opacity-70 ${
						state ? "h-52" : "h-0"
					}`}>
